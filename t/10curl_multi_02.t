...
my $p1 = http::curl_easy_perform($s);
is($p1, 0, 'http::curl_easy_perform(): return value ok P1');
my $p2 = http::curl_easy_perform($s);
is($p2, 0, 'http::curl_easy_perform(): return value ok P2');
