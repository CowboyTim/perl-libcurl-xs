...
$k |= http::curl_easy_setopt($e, http::CURLOPT_CLOSESOCKETFUNCTION(), \&open_sock_sub);
...
is($::o_cnt, 1, 'callback function called: ok open:'.$::o_cnt);
is($::c_cnt, 1, 'callback function called: ok close:'.$::c_cnt);
